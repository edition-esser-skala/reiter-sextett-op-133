...
IViola = {
  \relative c' {
    ...
    h4(-> c-.) c-. c-.
    c-. r r2
    \crescHairpin r8 \hairpinDashed f,,(\< e f gis a h c %420
    \dimHairpin f-.)\! \hairpinSolid a(\< gis a\! d\> c b a\!)
    cis4(-> d-.) d-. d-.
    d-. r r2
...
IIViola = {
  \relative c' {
    ...
    \dimHairpin \hairpinDashed c8.([\> a16  b8 d)]\! \hairpinSolid r2
...
IVViola = {
  \relative c' {
    ...
    << { \oneVoice \hairpinDashed f,4(\<^\markup { \remark "gesangsvoll" } g)\! \hairpinSolid } \\ { s2\mp } >> gis4(\sp a8 g16 f)
